...
valgrind --leak-check=full --track-origins=yes --show-leak-kinds=all -s ./client -p -t 1000 -W File_di_prova/minnie.txt -D Espulsi -c File_di_prova/minnie.txt -d Letti -r File_di_prova/minnie.txt
